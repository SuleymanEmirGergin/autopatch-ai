...
export default async function handler(
  ...
  try {
    ...
    let endpoint = `${BACKEND_URL}/api/reports/compliance`;
    
    if (path.includes("/export/excel")) {
      endpoint = `${BACKEND_URL}/api/reports/compliance/export/excel`;
    } else if (path.includes("/html")) {
      endpoint = `${BACKEND_URL}/api/reports/compliance/html`;
    } else if (path.includes("/markdown")) {
      endpoint = `${BACKEND_URL}/api/reports/compliance/markdown`;
    }
