...
export default async function handler(
  ...
  try {
    ...
    let endpoint = `${BACKEND_URL}/api/compliance/frameworks/${frameworkId}`;
    
    if (path.includes("/controls")) {
      endpoint = `${BACKEND_URL}/api/compliance/frameworks/${frameworkId}/controls`;
    } else if (path.includes("/requirements")) {
      endpoint = `${BACKEND_URL}/api/compliance/frameworks/${frameworkId}/requirements`;
    } else if (path.includes("/assessment")) {
      endpoint = `${BACKEND_URL}/api/compliance/frameworks/${frameworkId}/assessment`;
    }
