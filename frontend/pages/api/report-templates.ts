...
export default async function handler(
  ...
  try {
    ...
    let endpoint = `${BACKEND_URL}/api/report-templates`;
    
    if (path.includes("/categories")) {
      endpoint = `${BACKEND_URL}/api/report-templates/categories`;
    } else if (path.includes("/tags")) {
      endpoint = `${BACKEND_URL}/api/report-templates/tags`;
    } else if (path.includes("/default")) {
      endpoint = `${BACKEND_URL}/api/report-templates/default`;
    } else if (path.includes("/import")) {
      endpoint = `${BACKEND_URL}/api/report-templates/import`;
    } else if (path.includes("/initialize")) {
      endpoint = `${BACKEND_URL}/api/report-templates/initialize`;
    }
